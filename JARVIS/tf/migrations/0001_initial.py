    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission_type', models.IntegerField(choices=[(0, 'Free use'), (1, 'Single user'), (2, 'Team')], default=0)),
                ('permitted_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Team')),
                ('permitted_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.ExtendedUser')),
            ],
        ),
    ]
